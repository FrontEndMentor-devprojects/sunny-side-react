...
export default function Hero1({
  ...
  return (
    <div className="md:flex">
      ...
      <section className=" px-7 py-12 space-y-8 md:order-1 md:space-y-2 md:w-1/2 sm:p-14 md:p-10 lg:p-24 bg-white flex flex-col justify-between items-center md:items-baseline">
